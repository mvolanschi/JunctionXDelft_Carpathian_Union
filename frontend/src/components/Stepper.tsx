...
interface StepperProps extends HTMLAttributes<HTMLDivElement> {
  ...
  electricBorderSpeed?: number;
  electricBorderChaos?: number;
  electricBorderThickness?: number;
}
...
export default function Stepper({
  ...
  renderStepIndicator,
  electricBorderColor = "#4cc9f0",
  electricBorderSpeed = 1.2,
  electricBorderChaos = 0.8,
  electricBorderThickness = 2,
  ...rest
}: StepperProps) {
    ...
    <div className="outer-container" {...rest}>
      ...
      >
        <ElectricBorder
          ...
          speed={electricBorderSpeed}
          chaos={electricBorderChaos}
          thickness={electricBorderThickness}
          style={{
            position: "absolute",
            inset: 0,
            pointerEvents: "none",
